...
document.addEventListener("DOMContentLoaded", function () {
  ...
  header.innerHTML = `
        ...
        <li><a 
            id="sculpture" 
            class="navbar-item first-item" 
            href="/pages/sculpture.html">Sculpture</a></li>
        <li><a 
            id="painting" 
            class="navbar-item" 
            href="/pages/painting.html">Painting</a></li>
        <li><a 
            id="multimedia" 
            class="navbar-item" 
            href="/pages/multimedia.html">Multimedia</a></li>
        <li><a 
            id="print" 
            class="navbar-item" 
            href="/pages/print.html">Print</a></li>
        <li><a 
            id="about" 
            class="navbar-item last-item" 
